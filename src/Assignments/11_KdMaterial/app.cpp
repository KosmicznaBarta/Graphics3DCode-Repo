...
void SimpleShapeApplication::init() {
    ...
    // add Kd colors
    pyramid -> add_submesh(0, 6, kd_white_material);
    pyramid -> add_submesh(6, 9, kd_green_material);
    pyramid -> add_submesh(9, 12, kd_blue_material);
    pyramid -> add_submesh(12, 15, kd_red_material);
