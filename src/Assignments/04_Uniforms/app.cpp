...
void SimpleShapeApplication::init() {
    ...
    GLuint v_uniform_move_buffer;
    OGL_CALL(glCreateBuffers(1, &v_uniform_move_buffer));
    OGL_CALL(glNamedBufferData(v_uniform_move_buffer, 12 * sizeof(float), NULL, GL_DYNAMIC_DRAW));
    ...
    OGL_CALL(glBindBufferBase(GL_UNIFORM_BUFFER, 1, v_uniform_move_buffer))
