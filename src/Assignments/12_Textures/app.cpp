...
void SimpleShapeApplication::init() {
    ...
    GLenum internal_format = (channels == 4) ? GL_SRGB_ALPHA : GL_SRGB;
    ...
    // white primitive texture
    auto textured_material = new xe::KdMaterial(glm::vec4(1.0f, 1.0f, 1.0f, 1.0f), 0, texID);

    // colors from KdMaterial (not used)
    ...
    auto kd_white_material = new xe::KdMaterial(glm::vec4(1.0f, 1.0f, 1.0f, 1.0f), 0);
    ...
    std::vector<GLubyte> index_buffer = {0, 1, 2, 3, 0, 2, 2, 1, 4, 2, 5, 3, 3, 6, 0, 7, 1, 0};
    ...
    //         index_buffer.size() * sizeof(GLubyte), GL_UNSIGNED_BYTE, GL_STATIC_DRAW, xe::AttributeType::TEXCOORD_0);
    ...
    // add white primitive
    pyramid->add_primitive(0, 18, textured_material);
